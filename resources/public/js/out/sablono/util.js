...
sablono.util.ToString = (function (){var obj10612 = {};
return obj10612;
})();
...
sablono.util.ToURI = (function (){var obj10614 = {};
return obj10614;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__10615){
var xs = cljs.core.seq(arglist__10615);
...
var vec__10617 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__10617,(0),null);
var words = cljs.core.nthnext.call(null,vec__10617,(1));
...
var G__10619 = clojure.set.rename_keys.call(null,m,kmap);
var G__10619__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__10619,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),camel_case_keys):G__10619);
return G__10619__$1;
} else {
return m;
}
...
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__10620_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__10620_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__10620_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__10620_SHARP_)){
return p1__10620_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__10620_SHARP_], null);
...
merge_with_class.cljs$lang$applyTo = (function (arglist__10621){
var maps = cljs.core.seq(arglist__10621);
...
*/
sablono.util.normalize_element = (function normalize_element(p__10626){
