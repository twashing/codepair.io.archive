...
sablono.util.ToString = (function (){var obj10600 = {};
return obj10600;
})();
...
sablono.util.ToURI = (function (){var obj10602 = {};
return obj10602;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__10603){
var xs = cljs.core.seq(arglist__10603);
...
var vec__10605 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__10605,(0),null);
var words = cljs.core.nthnext.call(null,vec__10605,(1));
...
var G__10607 = clojure.set.rename_keys.call(null,m,kmap);
var G__10607__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__10607,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),camel_case_keys):G__10607);
return G__10607__$1;
} else {
return m;
}
...
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__10608_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__10608_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__10608_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__10608_SHARP_)){
...
merge_with_class.cljs$lang$applyTo = (function (arglist__10609){
var maps = cljs.core.seq(arglist__10609);
...
var vec__10613 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__10613,(0),null);
var names = cljs.core.nth.call(null,vec__10613,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__10613,tag_name,names){
return (function (p1__10610_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__10610_SHARP_));
});})(matches,vec__10613,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__10613,tag_name,names){
return (function (p1__10611_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__10611_SHARP_));
});})(matches,vec__10613,tag_name,names))
,names)))], null);
});
/**
...
*/
sablono.util.normalize_element = (function normalize_element(p__10614){
var vec__10617 = p__10614;
var tag = cljs.core.nth.call(null,vec__10617,(0),null);
var content = cljs.core.nthnext.call(null,vec__10617,(1));
...
var vec__10618 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__10618,(0),null);
var id = cljs.core.nth.call(null,vec__10618,(1),null);
var class$ = cljs.core.nth.call(null,vec__10618,(2),null);
